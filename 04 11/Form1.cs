    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            if (but == 4)
            {
                ...
                this.CreateGraphics().DrawEllipse(Pens.Green, currentRect);
            }
            if (but == 1)
            {
                isDrawing = false;
                ...
                rectangles.Add(currentRect);
                this.CreateGraphics().DrawRectangle(Pens.Green, currentRect);
            }
            if (but == 3)
            {
                if (e.Button == MouseButtons.Left)
        ...
        private void Form1_MouseClick(object sender, MouseEventArgs e)
        {
            if (but == 2)
            {
                ...
                points.Add(point);
                this.CreateGraphics().FillEllipse(Brushes.Green, point.X - 5, point.Y - 5, 10F, 10F);
            }
        }
